...
(function(){
    ...
    var div = document.getElementById('countdays');
    window.cd = new CountDays({
        date: new Date(2013, 7, 10, 17),
        callback: function (arr) {
            ...
            div.innerHTML = d + '<small>d</small>' + h + '<small>h</small>' + m + '<small>m</small>' + s + '<small>s</small>';
        }
    });
    cd.StartCount();
